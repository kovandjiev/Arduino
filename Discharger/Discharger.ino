...
#ifdef DISCHARGER1
const char* MQTT_CLIENT_ID = "DischargeClient1";
const char* DEVICE_TOPIC = "discharger1"; // Current device name
...
const double CUTOFF_VOLTAGE_CORRECTION = 0.3;
#endif // DISCHARGER2
...
const double CUTOFF_VOLTAGE = 7.5; // --- Full discharge 6.0, 50% discharge 7.5 ---------
